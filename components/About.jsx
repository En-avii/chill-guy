...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
          Hello! I&apos;m Abhishek Yadav, a passionate web developer and problem
          solver. Currently, I&apos;m pursuing a B.Tech degree in 
          Electronics and Commuincation Engineering in IIIT Senapti, India, with an expected
        ...
        <div className="w-fit break-words">
          <Link
            href="mailto:27abhiyadav@gmail.com"
            target="_blank"
            rel="noreferrer"
